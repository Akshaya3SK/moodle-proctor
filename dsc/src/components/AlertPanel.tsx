  ...
  return (
    <section className="glass-surface rounded-xl">
      <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3 dark:border-slate-800">
        ...
        <span className="text-sm text-slate-700 dark:text-slate-300">{alerts.length}</span>
      </div>
      ...
      <div className="scroll-thin max-h-[520px] space-y-2 overflow-y-auto p-3">
        {alerts.map((alert) => {
          ...
          return (
            <div
              key={alert.id}
              className="rounded-lg border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950/70"
            >
              ...
              <div className="mt-3 flex items-center justify-between text-xs">
                ...
                <button className="text-sky-500 hover:text-sky-600 dark:text-sky-300 dark:hover:text-sky-200">
                  Review
                </button>
              </div>
            </div>
